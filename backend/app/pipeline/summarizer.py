...
def generate_summary(
    ...
    uncertain_count = sum(1 for r in verification_results if r.get("status") == "uncertain")
...
Be direct and avoid hedging language."""
        ...
        logger.error(f"Gemini summary generation failed: {str(e)}, using fallback")
...
def _generate_fallback_summary(
    ...
    total = (verified_count or 0) + (disputed_count or 0) + (uncertain_count or 0)
